<template> 
    <div id="login_bg" class="animate__animated animate__bounceInDown">
        <div id="form">
            <h1>登陆丨注册</h1>
            <button @click="loginShow()">LOGIN</button>
            <button @click="registerShow()">REGISTER</button><br>
            <keep-alive>
        ...
        <!-- <Loader id="loader" v-if="loarderVisible"></Loader> -->
...
export default {
    ...
    methods: {
        login(){
            this.axios.get('http://www.liulongbin.top:3006/api/getbooks')
                .then(res => {
                    if (res.status == 200) {
                        console.log('登录成功')
